 ...
 */
export declare function createStartAPIHandler(cb: StartAPIHandlerCallback): import('vinxi/http').EventHandler<import('vinxi/http').EventHandlerRequest, Promise<Response>>;
